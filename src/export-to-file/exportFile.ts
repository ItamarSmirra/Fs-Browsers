...
export const exportCsvFile = (data, fileName: string = 'file.csv', headings?: string[]) => {
...
export const exportXlsxFile = (data: {}[], fileName: string = 'file.xlsx', options?: ExcelOptions) => {
